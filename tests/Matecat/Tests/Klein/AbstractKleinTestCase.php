...
abstract class AbstractKleinTestCase extends TestCase
{
    ...
    protected static function getTestFile(string $file): string
    {
        return (string)file_get_contents(static::getTestFilePath($file));
    }

    protected static function getTestFilePath(string $file): string
    {
